...
public class OltaRush extends Game {
	...
	public static final float LIGHT_INTENSITY = 50f;
...
//GL ES specific stuff
	...
	@Override
	public void create() {
		rock = new Texture(Gdx.files.internal("veg/trees/circle_tree_1.png"));
		rockNormals = new Texture(Gdx.files.internal("veg/trees/circle_tree_1_nmap.png"));
...
//handle mouse wheel
		Gdx.input.setInputProcessor(new InputAdapter() {
			...
			public boolean keyDown(int keycode) {
				LIGHT_POS.z = Math.max(0f, LIGHT_POS.z - (Gdx.graphics.getDeltaTime() * 0.005f));
	...
	public void resize(int width, int height) {
		...
		//LIGHT_POS.x = Gdx.graphics.getWidth()/2f;
		//LIGHT_POS.y = Gdx.graphics.getHeight()/2f;
...
/*two days ago on 22/05/2020, i found out that she's no more, juliana has passed away on 16/05/2020... i don't know what to say,
* my world is shattered, and i feel devastated, i don't know what to do or say... my hands are trembling, while writing
* these codes, i miss her, i miss her a lot... Rest in peace juli, i love you.*/
